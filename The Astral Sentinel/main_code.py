...
# Пути к текстурам кораблей и врагов (замените на свои изображения)
...
class MenuView(arcade.View):
    def __init__(self):
        ...
        # Новая кнопка «Посмотреть результаты»
        ...
        # Метка и dropdown для выбора корабля
        ...
        self.player_texture = self.textures[0]  # по умолчанию
        ...
        # Создаем изображения кораблей для отображения справа
        self.ship_images = []
...
class RulesView(arcade.View):
    def __init__(self):
        ...
        # Создаем объекты Text с правильными позициями
        self.text_objects = []
        y = SCREEN_HEIGHT - 150
    ...
    def on_key_press(self, key, modifiers):
        # Возврат в меню при любой клавише
        menu_view = MenuView()
...
class ResultsView(arcade.View):
    def __init__(self):
        ...
        # Создаем объекты Text для вывода результатов
        self.text_objects = []
        y = SCREEN_HEIGHT - 50
    ...
    def on_draw(self):
        ...
        for text_obj in self.text_objects:
            text_obj.draw()
        arcade.draw_text("Нажмите любую клавишу для возврата", 50, 20, arcade.color.WHITE, 14)
...
class GameView(arcade.View):
    ...
    def game_over(self):
        ...
        with open("results.txt", "a") as f:
            f.write(f"Игрок набрал {self.score} очков.\n")
        # Показать меню
        menu_view = MenuView()
        self.window.show_view(menu_view)
